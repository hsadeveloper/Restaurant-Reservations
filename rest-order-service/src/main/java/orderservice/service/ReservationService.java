...
public class ReservationService {
	...
	public void validateBooking(String customerId, LocalDate date, LocalTime time) {
        ...
        boolean hasDoubleBooking = reservationRepository.existsByCustomerIdAndReservationDateAndReservationTime(
    ...
    public ReservationResponse createReservation(CreateReservationRequest request) {    	
	        ...
	        logger.info("Inside createReservation   .. .............................................."+ LocalDateTime.now() );
    ...
    if (reservationTime.isBefore(now.plusMinutes(30))) {
     ...
     if (reservationLocalTime.isBefore(startTime) || reservationLocalTime.isAfter(endTime)) {
    	 logger.info("Booking Rejected: Outside operational hours. [Requested: {}], [Allowed: {}:00 - {}:00]", 
    			    reservationLocalTime, BOOKING_START_HOUR, BOOKING_END_HOUR);
         throw new RuntimeException("Booking Rejected: Outside operational hours. [Requested: {}], [Allowed: {}:00 - {}:00]");
     }
     ...
     // Step 1: Combine date + time to LocalDateTime
        ...
        if (statusCode.is2xxSuccessful()) { // Better practice for checking 200 OK
         ...
         if (res == null || res.getId() == null) {
            throw new RuntimeException("Table Service returned a successful response, but the Reservation ID is missing.");
         }
        ...
        return new ReservationResponse(
            ...
            res.getExpiresAt(),
            new Links(
                new Link("/api/reservations/" + reservationId + "/confirm", "POST")
            )
        );
    }
